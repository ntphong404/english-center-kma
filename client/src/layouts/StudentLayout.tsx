...
const StudentLayout = () => {
  ...
  const sidebarLinks = [
    ...
    { icon: <GraduationCap size={18} />, label: 'Lớp học của tôi', path: '/student/classes' },
      ...
      <div className="min-h-screen flex flex-col md:flex-row bg-gray-100 w-full">
        ...
        <main className="flex-1 flex flex-col">
          ...
          <footer className="bg-white p-4 text-center text-sm text-gray-500">
            &copy; {new Date().getFullYear()} English Center - Student Portal
          </footer>
        </main>
      </div>
    </SidebarProvider>
